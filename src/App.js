...
import { ResponsiveContainer, XAxis, YAxis, CartesianGrid,
  Tooltip, Legend, LineChart, Line, BarChart, Bar, Brush, PieChart,
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={6} sm={3}>
              <Paper className={classes.paper}>
                ...
                <Typography variant="h6">(+ {data_text.newConfirmed.toLocaleString()})</Typography>
              </Paper>
            </Grid>
            ...
            <Grid item xs={6} sm={3}>
              <Paper className={classes.paper}>
                ...
                <Typography variant="h6">(+ {data_text.newHospitalized.toLocaleString()})</Typography>
              </Paper>
            </Grid>
            ...
            <Grid item xs={6} sm={3}>
              <Paper className={classes.paper}>
                ...
                <Typography variant="h6">(+ {data_text.newDeaths.toLocaleString()})</Typography>
              </Paper>
            </Grid>
            ...
            <Grid item xs={6} sm={3}>
              <Paper className={classes.paper}>
                ...
                <Typography variant="h6">(+ {data_text.newRecovered.toLocaleString()})</Typography>
              </Paper>
            </Grid>
        ...
        <footer className={classes.footer}>
          <Paper className={classes.paper}>
            <Typography variant="h6">
              React App with Material UI for Thailand Covid-19 Dashboard
            </Typography>
          </Paper>
        </footer>
      </div>
